...
{
    [SerializeField] float skinWidthMultiplier = 0.98f;
    ...
    public float RaycastHorizontal(float distance)
    {
        ...
        hit = Physics2D.BoxCast(selfTr.position, actualSize, 0, Vector2.right * Mathf.Sign(distance), Mathf.Abs(distance), layerMask);
